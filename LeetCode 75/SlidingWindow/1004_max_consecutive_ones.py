...
3. Expand the `right` pointer to include more elements until the count of zeros exceeds `k`.
4. If it exceeds, move the `left` pointer to reduce the window size until the count of zeros is within `k`.
